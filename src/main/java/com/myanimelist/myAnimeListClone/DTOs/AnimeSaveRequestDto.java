 ...
 */
@Value
public record AnimeSaveRequestDto(Integer episodeCount, ItemStatus itemStatus, Date startDate, Date finishDate,
                                  ...
                                  Integer durationByMinute, Manga adaptionManga, List<Anime> alternativeVersionAnime,
                                  List<Anime> sideStoryAnimes, List<Anime> spinOfAnimes) implements Serializable {
}